    ...
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-8">
          New to crypto? No problem! This comprehensive guide will walk you
          through everything you need to get started with Football Squares, from
          buying your first cryptocurrency to connecting your wallet.
        </p>
      ...
      <Card className="mb-12 bg-white dark:bg-black border border-gray-200 dark:border-gray-800 shadow-sm">
        ...
        <CardContent className="space-y-6">
          <p className="text-gray-600 dark:text-gray-400 text-lg">
            Cryptocurrency is digital money that works on the internet. For
            Football Squares, we accept these types:
          </p>
            ...
            <div className="space-y-4">
              <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  The original cryptocurrency, widely accepted and trusted.
                </p>
              </div>
              <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-4">
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Popular for smart contracts and decentralized applications.
                </p>
              </div>
            </div>
            <div className="space-y-4">
              ...
              <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Digital dollars that maintain stable value.
                </p>
              </div>
            </div>
          </div>
      ...
      <Card className="mb-12 bg-white dark:bg-black border border-gray-200 dark:border-gray-800 shadow-sm">
        ...
        <CardContent className="space-y-6">
          <p className="text-gray-600 dark:text-gray-400 text-lg">
            These platforms let you buy cryptocurrency with your credit card,
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            ...
            <p className="text-blue-800 dark:text-blue-200 text-sm">
              <strong>Coinbase</strong> or <strong>Robinhood</strong> are the
              easiest to start with. They have user-friendly apps and good
              customer support.
            </p>
          </div>
        </CardContent>
      ...
      <Card className="mb-12 bg-white dark:bg-black border border-gray-200 dark:border-gray-800 shadow-sm">
        ...
        <CardContent className="space-y-6">
          <p className="text-gray-600 dark:text-gray-400 text-lg">
            Phantom is a browser wallet that lets you store and use Solana
            ...
            <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-6">
              ...
              <ol className="space-y-3 text-gray-600 dark:text-gray-400">
                ...
                <li className="flex gap-3">
                  ...
                  <span>
                    <strong>IMPORTANT:</strong> Write down your Secret Recovery
                    Phrase and store it safely
                  </span>
                </li>
              </ol>
            </div>
          ...
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
            ...
            <ul className="text-red-800 dark:text-red-200 text-sm space-y-1">
              ...
              <li>
                • If someone gets your phrase, they can steal all your crypto
              </li>
      ...
      <Card className="mb-12 bg-white dark:bg-black border border-gray-200 dark:border-gray-800 shadow-sm">
        ...
        <CardContent className="space-y-6">
          <p className="text-gray-600 dark:text-gray-400 text-lg">
            Now you need to move your cryptocurrency from the exchange to your
            Phantom wallet:
          </p>
            ...
            <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-6">
              ...
              <ol className="space-y-3 text-gray-600 dark:text-gray-400">
                ...
                <li className="flex gap-3">
                  ...
                  <span>
                    Copy your wallet address (starts with letters/numbers)
                  </span>
                </li>
              </ol>
            </div>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
            ...
            <p className="text-green-800 dark:text-green-200 text-sm">
              ...
              Squares with cryptocurrency. Your wallet is secure, funded, and
              connected.
            </p>
          </div>
        </CardContent>
      ...
      <Card className="mb-12 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        ...
        <CardContent className="space-y-4">
          <p className="text-blue-100 text-lg">
            Watch our comprehensive 15-minute video tutorial that covers
            everything from buying your first cryptocurrency to playing your
            first Football Squares game.
          </p>
          ...
          <div className="bg-black rounded-lg aspect-video flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">
                Full walkthrough of the entire process
              </p>
            </div>
          </div>
      ...
      <Card className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 shadow-sm">
        ...
        <CardContent className="text-center space-y-4">
          <p className="text-gray-600 dark:text-gray-400">
            Our support team is here to help you get started with cryptocurrency
            and Football Squares.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
