...
const CBLCallToActionCard: React.FC<CBLCallToActionCardProps> = ({
  className = '',
}) => {
  return (
    <Card
      className={`bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950 dark:to-purple-950 border-blue-200 dark:border-blue-800 ${className}`}
    >
      ...
      <CardContent className="space-y-4">
        <p className="text-sm text-gray-600 dark:text-gray-300">
          Become a Community Board Leader and earn rewards while managing your
          own football squares community.
        </p>
