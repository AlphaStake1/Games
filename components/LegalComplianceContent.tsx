...
const LegalComplianceContent = () => {
      ...
      rules: [
        {
          ...
          description: "Cannot attempt to exploit smart contract vulnerabilities",
          importance: "Critical",
          details: [
      ...
      items: [
        {
          ...
          dataShared: "Public wallet addresses, transaction data, smart contract interactions",
          reason: "Decentralized game operation and transparent payouts",
          protections: "Public blockchain data, no additional privacy beyond network design",
        },
        {
        ...
        },
        {
          ...
          dataShared: "Technical logs, usage analytics, contact info (if provided)",
          reason: "Platform maintenance, analytics, customer support",
          protections: "Data processing agreements, access controls, audit trails",
        },
        {
          recipient: "Community Platforms",
          dataShared: "Public wallet addresses, game statistics (if you choose to share)",
    ...
    },
    {
      ...
      rights: [
        ...
        },
        {
          ...
          howTo: "Submit deletion request through support (note: some data must be retained legally)",
          timeframe: "Within 30 days, subject to legal retention requirements",
        },
        {
          right: "Data Portability",
          description: "Receive your data in a portable format",
          howTo: "Request through support - data provided in common formats (CSV, JSON)",
          timeframe: "Within 30 days of request",
        },
        {
          right: "Opt-Out of Marketing",
          description: "Stop receiving promotional communications",
          howTo: "Unsubscribe links in emails, or adjust preferences in account settings",
          timeframe: "Immediate for email, up to 10 days for other communications",
        },
      ],
    },
  ];
      ...
      regions: [
        {
          ...
          reason: "Sanctions, legal restrictions, or lack of regulatory framework",
        },
        {
          name: "Under Review",
  ...
  const disputeProcess = [
    {
      ...
      description: "First, try to resolve the issue directly with our support team",
      process: [
      ...
      escalation: "If not satisfied with response, you can escalate to management review",
    },
    {
      step: 2,
      ...
      description: "Senior management will review complex or unresolved disputes",
      process: [
      ...
      escalation: "If still not satisfied, you can pursue independent arbitration",
    },
    {
      step: 3,
      ...
      description: "Binding arbitration through our designated arbitration service",
      process: [
  ...
  const legalContacts = [
    ...
    },
    {
      ...
      description: "Regulatory questions, licensing inquiries, government requests",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[#708090] dark:text-[#96abdc] max-w-3xl mx-auto mb-8 transition-colors duration-300">
            Understand your rights, responsibilities, and the legal framework governing your 
            Football Squares experience. Learn about our terms, privacy practices, and compliance measures.
          </p>
            ...
            <div className="p-8 lg:p-12">
              ...
              <div className="mb-12 bg-gradient-to-r from-[#ed5925] to-[#96abdc] rounded-xl p-8 text-white">
                ...
                <p className="text-lg mb-4">
                  This page provides a summary of key terms for easy understanding. The complete, 
                  legally binding Terms of Service document takes precedence in all cases.
                </p>
                    ...
                    <CardContent>
                      <div className="space-y-6">
                        {category.rules.map((rule, ruleIndex) => (
                          <div key={ruleIndex} className="border border-gray-200 dark:border-[#004953] rounded-lg p-6 transition-colors duration-300">
                            <div className="flex items-center justify-between mb-4">
                              <h4 className="text-lg font-bold text-[#002244] dark:text-white transition-colors duration-300">
                                {rule.title}
                              </h4>
                              <span className={`px-3 py-1 rounded-full text-xs font-bold ${
                                rule.importance === 'Critical' ? 'bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-300' :
                                rule.importance === 'High' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-300' :
            ...
            <div className="p-8 lg:p-12">
              ...
              <div className="mb-12 bg-gradient-to-r from-[#004953] to-[#002244] rounded-xl p-8 text-white">
                ...
                <p className="text-lg mb-4">
                  ...
                  This summary explains our key privacy practices in plain language.
                </p>
                <div className="flex flex-wrap gap-4">
                      ...
                      {(privacyHighlights[0].items as Array<{
                        ...
                        <div key={index} className="border border-gray-200 dark:border-[#004953] rounded-lg p-6 transition-colors duration-300">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div>
                              <h5 className="font-semibold text-[#ed5925] mb-2">What We Collect:</h5>
                              <ul className="space-y-1">
                                {item.collected.map((data, dataIndex) => (
                                  <li key={dataIndex} className="text-sm text-[#708090] dark:text-[#96abdc] transition-colors duration-300">
                                    • {data}
                                  </li>
                                ))}
                              </ul>
                            ...
                            <div>
                              <h5 className="font-semibold text-[#ed5925] mb-2">Why We Need It:</h5>
                              <p className="text-sm text-[#708090] dark:text-[#96abdc] transition-colors duration-300">
                                {item.purpose}
                              </p>
                            </div>
                            <div>
                              <h5 className="font-semibold text-[#ed5925] mb-2">How Long We Keep It:</h5>
                              <p className="text-sm text-[#708090] dark:text-[#96abdc] transition-colors duration-300">
                                {item.retention}
                              </p>
                            </div>
                            <div>
                              <h5 className="font-semibold text-[#ed5925] mb-2">Your Control:</h5>
                  ...
                  <CardContent>
                    <div className="space-y-6">
                      {(privacyHighlights[2].rights as Array<{
                        ...
                        <div key={index} className="flex items-start gap-4 p-4 border border-gray-200 dark:border-[#004953] rounded-lg transition-colors duration-300">
                      ...
                      {status.regions && (
                        <div className="space-y-6">
                          {status.regions.map((region, regionIndex) => (
                            <div key={regionIndex} className="border border-gray-200 dark:border-[#004953] rounded-lg p-6 transition-colors duration-300">
                              ...
                              {'restrictions' in region && region.restrictions && (
                                <div className="mb-4">
                                  <h5 className="font-semibold text-yellow-600 mb-2">Restrictions:</h5>
                                  <ul className="space-y-1">
                              ...
                              {'requirements' in region && region.requirements && (
                                <div>
                                  <h5 className="font-semibold text-[#ed5925] mb-2">Requirements:</h5>
                                  <ul className="space-y-1">
                                    {region.requirements.map((requirement, index) => (
                                      <li key={index} className="flex items-start gap-2">
                                        <CheckCircle className="w-4 h-4 text-[#ed5925] mt-0.5 flex-shrink-0" />
                                        <span className="text-sm text-[#708090] dark:text-[#96abdc] transition-colors duration-300">
                                          {requirement}
                              ...
                              {'countries' in region && region.countries && (
                                <div>
                                  <h5 className="font-semibold text-red-600 mb-2">Affected Countries:</h5>
                                  <div className="flex flex-wrap gap-2 mb-3">
                                    {region.countries.map((country, index) => (
                                      <span key={index} className="bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-300 px-2 py-1 rounded text-xs">
                                        {country}
                                      </span>
                                    ))}
                                  </div>
                          ...
                          <div className="mb-4">
                            ...
                            <ol className="space-y-2">
                              {step.process.map((process, processIndex) => (
                                <li key={processIndex} className="flex items-start gap-2">
                    ...
                    <Card key={index}>
                      <CardContent className="p-6">
                        ...
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <a href={`mailto:${contact.email}`} className="text-[#ed5925] hover:underline">
                            {contact.email}
                          </a>
                        </div>
              ...
              <div className="bg-[#faf9f5] dark:bg-[#1a1a2e] rounded-xl p-8 transition-colors duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <p className="text-[#708090] dark:text-[#96abdc] mb-4 transition-colors duration-300">
                      Arbitration is a legal process where a neutral third party (arbitrator) makes a 
                      binding decision about your dispute. It's typically faster and less expensive than going to court.
                    </p>
                    <h4 className="font-semibold text-[#002244] dark:text-white mb-3 transition-colors duration-300">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="bg-white dark:bg-[#002244] rounded-lg p-4 border border-gray-200 dark:border-[#004953] transition-colors duration-300">
                        <h5 className="font-semibold text-[#ed5925] mb-1">Filing Fee:</h5>
                        <p className="text-sm text-[#708090] dark:text-[#96abdc] transition-colors duration-300">
                          $200-$500 depending on claim amount
                        </p>
                      </div>
                      <div className="bg-white dark:bg-[#002244] rounded-lg p-4 border border-gray-200 dark:border-[#004953] transition-colors duration-300">
                        <h5 className="font-semibold text-[#ed5925] mb-1">Arbitrator Fee:</h5>
                        <p className="text-sm text-[#708090] dark:text-[#96abdc] transition-colors duration-300">
                          Split between parties (typically $1,000-$3,000 total)
                        </p>
                      </div>
                      <div className="bg-white dark:bg-[#002244] rounded-lg p-4 border border-gray-200 dark:border-[#004953] transition-colors duration-300">
                        <h5 className="font-semibold text-[#ed5925] mb-1">Fee Refund:</h5>
                        <p className="text-sm text-[#708090] dark:text-[#96abdc] transition-colors duration-300">
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-[#708090] dark:text-[#96abdc] mb-8 transition-colors duration-300">
            Our legal team is here to help answer your questions and resolve any concerns.
          </p>
