            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                  ...
                  <p className="text-[#96abdc] text-sm">
                    Replace standard signatures with your unique NFT designs
                  </p>
                </div>
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                  ...
                  <p className="text-[#96abdc] text-sm">
                    Stored on Solana blockchain with verified ownership
                  </p>
                </div>
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                  ...
                  <p className="text-[#96abdc] text-sm">
                    Low-cost minting and instant transfers on Solana
                  </p>
                </div>
              </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-[#708090] dark:text-[#96abdc] max-w-3xl mx-auto">
              Non-Fungible Tokens are unique digital assets that prove ownership
                ...
                <CardContent className="p-8">
                  ...
                  <div className="space-y-4">
                    <div className="bg-[#faf9f5] dark:bg-[#444341]/50 rounded-xl p-4">
                      <h4 className="font-bold text-[#002244] dark:text-white mb-2">
                        💰 Fungible (Like Money)
                      </h4>
                      <p className="text-[#708090] dark:text-[#96abdc] text-sm">
                        One dollar bill = Another dollar bill. Interchangeable
                        with equal value.
                      </p>
                    </div>
                    <div className="bg-[#ed5925]/5 dark:bg-[#ed5925]/10 rounded-xl p-4 border border-[#ed5925]/20">
                      ...
                      <p className="text-[#708090] dark:text-[#96abdc] text-sm">
                        Mona Lisa ≠ Any other painting. Unique, one-of-a-kind,
                        irreplaceable.
                      </p>
                    </div>
                  </div>
              ...
              <Card className="bg-white dark:bg-[#002244] border-2 border-[#96abdc]/20 dark:border-[#96abdc]/30 shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-8">
                  ...
                  <p className="text-[#708090] dark:text-[#96abdc] leading-relaxed">
                    NFTs use blockchain technology to create a permanent,
                    tamper-proof record of ownership. When you own an NFT, the
                    blockchain serves as your digital certificate of
                    authenticity - no one can dispute your ownership or create
                    identical copies.
                  </p>
                </CardContent>
              </Card>
              ...
              <div className="space-y-6">
                <div className="bg-white dark:bg-[#002244] rounded-2xl p-6 shadow-lg border border-[#708090]/10">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h4 className="font-bold text-[#002244] dark:text-white">
                        Personal Square Markers
                      </h4>
                      <p className="text-[#708090] dark:text-[#96abdc] text-sm">
                        Replace boring signatures
                      </p>
                    </div>
                  </div>
                  <p className="text-[#708090] dark:text-[#96abdc] text-sm">
                    Your NFTs become visual markers on any square you purchase.
                    Instead of seeing "John D." in basic black text, you'll see
                    your custom NFT design.
                  </p>
                </div>
                ...
                <div className="bg-white dark:bg-[#002244] rounded-2xl p-6 shadow-lg border border-[#708090]/10">
                  ...
                  <p className="text-[#708090] dark:text-[#96abdc] text-sm">
                    Each NFT is a permanent collectible you own forever. Trade
                    them, sell them, or showcase your collection in your digital
                    wallet.
                  </p>
                </div>
                ...
                <div className="bg-white dark:bg-[#002244] rounded-2xl p-6 shadow-lg border border-[#708090]/10">
                  ...
                  <p className="text-[#708090] dark:text-[#96abdc] text-sm">
                    Win NFTs in free games, purchase them directly, or redeem
                    them from your game winnings. Start building your collection
                    today!
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <CardContent className="p-8 relative z-10">
                  <div className="text-center mb-6">
                    <div
                      className={`w-20 h-20 bg-gradient-to-br ${tier.gradient} rounded-2xl flex items-center justify-center mx-auto mb-4 transform group-hover:scale-110 transition-transform duration-300`}
                    >
                    ...
                    <div
                      className={`text-4xl font-bold bg-gradient-to-r ${tier.gradient} bg-clip-text text-transparent mb-3`}
                    >
                      {tier.price}
                    </div>
                  ...
                  <div className="space-y-3 mb-6">
                    {tier.features.map((feature, featureIndex) => (
                      ...
                      >
                        <CheckCircle
                          className={`w-5 h-5 text-[#ed5925] flex-shrink-0`}
                        />
                        <span className="text-[#708090] dark:text-[#96abdc] text-sm">
                          {feature}
                        </span>
                      </div>
                    ))}
                  ...
                  <div className="bg-white dark:bg-[#002244]/50 rounded-xl p-4 border border-[#708090]/10">
                    <p className="text-xs text-[#708090] dark:text-[#96abdc] font-medium mb-1">
                      Example:
                    </p>
                    <p className="text-[#002244] dark:text-white text-sm font-medium">
                      {tier.example}
                    </p>
                  </div>
            ...
            <div className="relative z-10">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-[#96abdc] max-w-3xl mx-auto">
                  Experience the fastest, most affordable NFT platform with
                  instant transactions and minimal fees
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <p className="text-[#96abdc] mb-6 leading-relaxed">
                      Once minted, your NFTs automatically appear in your
                      Phantom wallet's collectibles section. You can view,
                      manage, and transfer them just like any other digital
                      asset.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4">
                      <Button className="bg-white dark:bg-white text-[#002244] dark:text-[#002244] px-6 py-3 rounded-full font-bold hover:bg-gray-100 dark:hover:bg-gray-200 transition-all duration-300">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="bg-white/20 rounded-lg p-3">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm">
                              Trophy Collection NFT
                            </span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <p className="text-xs text-[#96abdc] text-center">
                      Your NFTs in wallet collectibles
                    </p>
                  </div>
                </div>
              </div>
            ...
            <CardContent className="p-8 lg:p-16 relative z-10">
              <div className="text-center mb-12">
                <div className="inline-flex items-center gap-3 bg-[#8d594d]/10 backdrop-blur-sm rounded-full px-6 py-3 mb-6">
                  ...
                  <span className="text-sm font-semibold text-[#002244] dark:text-white">
                    NFT Burning
                  </span>
                </div>
                <h2 className="text-4xl lg:text-5xl font-bold text-[#002244] dark:text-white mb-6">
                ...
                <p className="text-xl text-[#708090] dark:text-[#96abdc] max-w-3xl mx-auto mb-8">
                  Permanently destroy unwanted NFTs and reclaim the small amount
                  of SOL used for storage rent. Clean up your wallet and get
                  back your Solana tokens.
                </p>
                ...
                <div className="space-y-8">
                  <div className="bg-white dark:bg-[#002244] rounded-2xl p-6 shadow-lg border border-[#708090]/10">
                    ...
                    <p className="text-[#708090] dark:text-[#96abdc] leading-relaxed mb-4">
                      Burning an NFT means permanently destroying it on the
                      blockchain. This process is irreversible - once burned,
                      the NFT cannot be recovered or recreated.
                    </p>
                    <p className="text-[#708090] dark:text-[#96abdc] leading-relaxed">
                      When you burn an NFT on Solana, you reclaim the "rent" (a
                      small amount of SOL) that was locked up to store the NFT
                    ...
                    <div className="space-y-4">
                      {burnBenefits.map((benefit, index) => (
                        <div key={index} className="flex items-start gap-4">
                          ...
                          <div>
                            <h4 className="font-bold text-[#002244] dark:text-white mb-1">
                              {benefit.title}
                            </h4>
                            <p className="text-[#708090] dark:text-[#96abdc] text-sm">
                              {benefit.description}
            ...
            <CardContent className="p-12 lg:p-20 relative z-10">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-xl lg:text-2xl text-[#96abdc] mb-12 leading-relaxed">
                  Transform your Football Squares experience with personalized
                  NFT markers. Stand out from the crowd and build your unique
                  digital collection.
                </p>
