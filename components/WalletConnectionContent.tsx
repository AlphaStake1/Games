...
import { Wallet, Shield, ExternalLink, CheckCircle, AlertTriangle, Eye, Zap, Link } from 'lucide-react'
  ...
  const phantomFeatures = [
    {
      ...
      icon: "🔗",
      benefits: ["Trade SOL, ETH, and ERC-20 tokens", "Switch networks seamlessly", "Single wallet for multiple chains"]
    },
    {
  ...
  const officialResources = [
    {
      ...
      icon: "📖",
      features: ["Step-by-step screenshots", "Troubleshooting tips", "Security best practices"]
    },
    {
      ...
      icon: "📱",
      features: ["iOS and Android setup", "Face ID/Touch ID configuration", "Mobile-specific features"]
    },
    {
      ...
      icon: "🌐",
      features: ["Chrome, Firefox, Edge support", "Extension security", "Desktop features"]
    },
    {
      ...
      icon: "🔗",
      features: ["Network switching", "EVM compatibility", "Cross-chain transactions"]
    }
  ]
  ...
  const buyingOptions = [
    {
      ...
      time: "Instant",
      guide: "https://help.phantom.app/hc/en-us/articles/8071074929299-How-to-buy-SOL-in-Phantom",
    ...
    },
    {
      ...
      fees: "1.49% + $0.99",
      time: "5-10 minutes",
      guide: "https://help.coinbase.com/en/coinbase/trading-and-funding/buying-selling-or-converting-crypto/how-to-buy-sell-or-convert-crypto",
    ...
    },
    {
      ...
      guide: "https://support.kraken.com/hc/en-us/articles/360000613806-How-to-buy-and-sell-cryptocurrencies-and-FX-on-Kraken",
  ...
  const setupSteps = [
    {
      ...
      officialGuide: "https://help.phantom.app/hc/en-us/articles/4418394342035-How-to-create-a-new-wallet",
    ...
    },
    {
      ...
      officialGuide: "https://help.phantom.app/hc/en-us/articles/8071074929299-How-to-buy-SOL-in-Phantom",
    ...
    },
    {
      ...
      officialGuide: "https://help.phantom.app/hc/en-us/articles/4412004792595-Connecting-to-dApps",
    ...
    },
    {
      ...
      officialGuide: "https://help.phantom.app/hc/en-us/articles/4412004777491-Confirming-a-transaction",
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f8fafc] to-[#e2e8f0] dark:from-[#001a1a] dark:to-[#002244] transition-colors duration-300">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
              Connect your Solana wallet to participate in trustless Football Squares
            </p>
            <div className="bg-[#ed5925] bg-opacity-20 backdrop-blur-sm rounded-lg p-6 max-w-3xl mx-auto">
              <div className="flex items-start gap-3">
                ...
                <div className="text-left">
                  <h3 className="font-bold text-white mb-2">Trustless System</h3>
                  <p className="text-blue-100">
                    Your wallet connects directly to smart contracts on Solana. No deposits, withdrawals, or custodial risk. 
                    Game rules are enforced by immutable code, not human judgment.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap gap-1 py-4">
            {[
              ...
              { id: 'phantom', label: 'Phantom Features', icon: <Wallet className="w-4 h-4" /> },
              { id: 'resources', label: 'Official Guides', icon: <ExternalLink className="w-4 h-4" /> },
              { id: 'setup', label: 'Setup Process', icon: <Zap className="w-4 h-4" /> },
              { id: 'security', label: 'Security Tips', icon: <Shield className="w-4 h-4" /> }
            ].map((tab) => (
              <button
                key={tab.id}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div>
                    <p className="text-[#708090] dark:text-[#96abdc] text-lg leading-relaxed mb-6 transition-colors duration-300">
                      Football Squares uses a trustless system built on Solana smart contracts. Your wallet connects directly to the blockchain - no middleman, no custody risk.
                    </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-yellow-700 dark:text-yellow-300">
                      Coach B is an information assistant, not a gaming operator. All games are powered by autonomous smart contracts. 
                      Players are responsible for understanding tax obligations on any on-chain winnings.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-8">
              <div className="bg-white dark:bg-[#001a1a] rounded-xl shadow-xl p-8 border border-gray-200 dark:border-[#004953] transition-colors duration-300">
                ...
                <p className="text-[#708090] dark:text-[#96abdc] text-lg mb-8 transition-colors duration-300">
                  Phantom is the recommended wallet for Football Squares. It now supports both Solana and Ethereum networks, making it perfect for all your crypto needs.
                </p>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {phantomFeatures.map((feature, index) => (
                    <div key={index} className="border border-gray-200 dark:border-[#004953] bg-white dark:bg-[#001a1a] rounded-lg p-6 transition-colors duration-300">
                      ...
                      <ul className="space-y-1">
                        {feature.benefits.map((benefit, benefitIndex) => (
                          <li key={benefitIndex} className="flex items-center gap-2 text-sm text-[#708090] dark:text-[#96abdc]">
          ...
          {activeTab === 'resources' && (
            <div className="space-y-8">
              <div className="bg-white dark:bg-[#001a1a] rounded-xl shadow-xl p-8 border border-gray-200 dark:border-[#004953] transition-colors duration-300">
                ...
                <p className="text-[#708090] dark:text-[#96abdc] text-lg mb-8 transition-colors duration-300">
                  Use these official resources from Phantom and major exchanges for setup and troubleshooting.
                </p>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {officialResources.map((resource, index) => (
                    <div key={index} className="border border-gray-200 dark:border-[#004953] bg-white dark:bg-[#001a1a] rounded-lg p-6 transition-colors duration-300 hover:shadow-lg">
                        ...
                        <div className="flex-1">
                          ...
                          <ul className="space-y-1 mb-4">
                            {resource.features.map((feature, featureIndex) => (
                              <li key={featureIndex} className="flex items-center gap-2 text-sm text-[#708090] dark:text-[#96abdc]">
              ...
              <div className="bg-white dark:bg-[#001a1a] rounded-xl shadow-xl p-8 border border-gray-200 dark:border-[#004953] transition-colors duration-300">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {buyingOptions.map((option, index) => (
                    <div key={index} className={`border-2 rounded-lg p-6 transition-all duration-300 ${
                      option.recommended
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                        <div>
                          <span className="text-[#708090] dark:text-[#96abdc]">Fees:</span>
                          <br />
                          <span className="font-bold text-[#002244] dark:text-white">{option.fees}</span>
                        </div>
                        <div>
                          <span className="text-[#708090] dark:text-[#96abdc]">Time:</span>
                          <br />
                          <span className="font-bold text-[#002244] dark:text-white">{option.time}</span>
                        </div>
                      </div>
          ...
          {activeTab === 'setup' && (
            <div className="space-y-8">
              <div className="bg-white dark:bg-[#001a1a] rounded-xl shadow-xl p-8 border border-gray-200 dark:border-[#004953] transition-colors duration-300">
                ...
                <p className="text-[#708090] dark:text-[#96abdc] text-lg mb-8 transition-colors duration-300">
                  Follow these steps to get your wallet connected and ready to play.
                </p>
                      ...
                      <div className="flex-1">
                        ...
                        <ul className="space-y-2 mb-4">
                          {step.details.map((detail, detailIndex) => (
                            <li key={detailIndex} className="flex items-start gap-2 text-[#708090] dark:text-[#96abdc] transition-colors duration-300">
          ...
          {activeTab === 'security' && (
            <div className="space-y-8">
              <div className="bg-white dark:bg-[#001a1a] rounded-xl shadow-xl p-8 border border-gray-200 dark:border-[#004953] transition-colors duration-300">
                ...
                <p className="text-[#708090] dark:text-[#96abdc] text-lg mb-8 transition-colors duration-300">
                  Protect your funds and maintain security with these essential practices.
                </p>

                <div className="space-y-8">
                  {securityTips.map((section, index) => (
                    <div key={index} className="bg-gradient-to-r from-blue-50 to-green-50 dark:from-blue-900/20 dark:to-green-900/20 p-6 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <div className="mt-8 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 p-6 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-red-800 dark:text-red-300 mb-2">Never Share These</h3>
                      ...
                      <p className="text-red-700 dark:text-red-300 mt-3 text-sm">
                        Coach B will never ask for any of this information. Anyone requesting it is attempting to steal your funds.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <div className="bg-[#002244] text-white py-8">
        <div className="container mx-auto px-4 text-center">
          <p className="text-blue-100">
            Coach B is an information assistant, not a gaming operator. All games are powered by autonomous smart contracts on Solana.
          </p>
        </div>
      </div>
    </div>
