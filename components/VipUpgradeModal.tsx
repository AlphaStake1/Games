  ...
  const vipBenefits = [
    {
      ...
      description:
        'Select as many squares as you want on any board - no more 5 square limit!',
      highlight: true,
    },
    {
      ...
      description:
        'Access to $250, $500, and $1000 per square boards with massive payouts',
      highlight: true,
    },
    {
      ...
      description:
        'VIPs receive a 5% bonus payout on every winning square for the entire season.',
      highlight: true,
    },
    {
      ...
      description:
        'View and participate in games from all 32 NFL teams, not just your region',
      highlight: false,
    },
    {
    ...
    },
    {
      ...
      description:
        'VIPs unlock exclusive perks and surprises throughout the season.',
      highlight: false,
    },
  ];
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      ...
                      <div className="text-xs text-gray-500 mt-1 space-y-1">
                        ...
                        <p>
                          Total Potential: Win Q1, Q2, Q3, and half of Q4 (OT
                          split).
                        </p>
