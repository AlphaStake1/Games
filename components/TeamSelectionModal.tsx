      ...
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-center text-lg">
            This will be your home team and you'll see their schedule and
            regional games.
            <br />
        ...
        <div className="text-center text-sm text-gray-500 mt-4">
          <p>
            Your selected team will determine which regional games and boards
            you see.
          </p>
          <p>Upgrade to VIP to access all teams and premium board tiers.</p>
        </div>
      </DialogContent>
    </Dialog>
  );
