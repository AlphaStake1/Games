...
import { Shield, Users, AlertTriangle, Heart, MessageSquare, Flag, Eye, Scale, Lightbulb, Star, Clock, CheckCircle, XCircle, ArrowRight } from 'lucide-react'
  ...
  const communityValues = [
    {
      ...
      description: "Treat all community members with dignity and respect, regardless of background or experience level."
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Fair Play",
      description: "Maintain integrity in all games and interactions. No cheating, exploitation, or unfair advantages."
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Supportive Community",
      description: "Help newcomers learn, celebrate successes together, and create a welcoming environment for all."
    },
    {
      icon: <Lightbulb className="w-6 h-6" />,
      title: "Constructive Communication",
      description: "Share knowledge, provide helpful feedback, and engage in meaningful discussions."
    }
  ]
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
              Building a respectful, inclusive, and enjoyable community for all Football Squares enthusiasts
            </p>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
              {communityValues.map((value, index) => (
                <div key={index} className="bg-white bg-opacity-10 p-4 rounded-lg backdrop-blur-sm">
                  <div className="text-[#ed5925] mb-2">
                    {value.icon}
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap gap-1 py-4">
            {[
              ...
              { id: 'conduct', label: 'Code of Conduct', icon: <Shield className="w-4 h-4" /> },
              { id: 'prohibited', label: 'Prohibited Activities', icon: <XCircle className="w-4 h-4" /> },
              { id: 'reporting', label: 'Reporting', icon: <Flag className="w-4 h-4" /> },
              { id: 'moderation', label: 'Moderation', icon: <Scale className="w-4 h-4" /> },
              { id: 'safety', label: 'Safety Tips', icon: <AlertTriangle className="w-4 h-4" /> }
            ].map((tab) => (
              <button
                key={tab.id}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div>
                    <p className="text-[#708090] dark:text-[#96abdc] text-lg leading-relaxed mb-6 transition-colors duration-300">
                      Football Squares is more than just a platform - it's a community of passionate football fans who come together to enjoy the game, share strategies, and build lasting connections.
                    </p>
                    ...
                    <p className="text-[#708090] dark:text-[#96abdc] leading-relaxed transition-colors duration-300">
                      To create a safe, inclusive, and enjoyable environment where football enthusiasts can engage in fair competition, share knowledge, and celebrate the sport we all love.
                    </p>
                  </div>
                ...
                <div className="bg-white dark:bg-[#001a1a] rounded-xl shadow-xl p-6 border border-gray-200 dark:border-[#004953] transition-colors duration-300">
                  ...
                  <ul className="space-y-2">
                    {[
                      ...
                      <li key={index} className="flex items-start gap-2 text-[#708090] dark:text-[#96abdc] transition-colors duration-300">
            ...
            <div className="space-y-8">
              <div className="bg-white dark:bg-[#001a1a] rounded-xl shadow-xl p-8 border border-gray-200 dark:border-[#004953] transition-colors duration-300">
                ...
                <p className="text-[#708090] dark:text-[#96abdc] text-lg mb-8 transition-colors duration-300">
                  Our code of conduct establishes the foundation for respectful and positive interactions within our community.
                </p>

                <div className="space-y-8">
                  {conductRules.map((section, index) => (
                    <div key={index} className="border border-gray-200 dark:border-[#004953] rounded-lg transition-colors duration-300">
                      <button
                      ...
                      >
                        ...
                        <ArrowRight 
                          className={`w-5 h-5 text-[#708090] transform transition-transform duration-300 ${
                            expandedSection === `conduct-${index}` ? 'rotate-90' : ''
                          }`} 
                        />
                      </button>
                      ...
                      {expandedSection === `conduct-${index}` && (
                        <div className="px-6 pb-6">
                          <div className="mb-6">
                            <h4 className="font-semibold text-[#002244] dark:text-white mb-3 transition-colors duration-300">Rules:</h4>
                            <ul className="space-y-2">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
                              <h5 className="font-semibold text-green-800 dark:text-green-400 mb-2">✅ Good Examples:</h5>
                              <ul className="space-y-2">
                                {section.examples.good.map((example, exampleIndex) => (
                                  <li key={exampleIndex} className="text-sm text-green-700 dark:text-green-300 italic">
                                    "{example}"
                                  </li>
                                ))}
                              </ul>
                            ...
                            <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg border border-red-200 dark:border-red-800">
                              <h5 className="font-semibold text-red-800 dark:text-red-400 mb-2">❌ Bad Examples:</h5>
                              <ul className="space-y-2">
                                {section.examples.bad.map((example, exampleIndex) => (
                                  <li key={exampleIndex} className="text-sm text-red-700 dark:text-red-300 italic">
                                    "{example}"
                                  </li>
                                ))}
                              </ul>
          ...
          {activeTab === 'prohibited' && (
            <div className="space-y-8">
              <div className="bg-white dark:bg-[#001a1a] rounded-xl shadow-xl p-8 border border-gray-200 dark:border-[#004953] transition-colors duration-300">
                ...
                <p className="text-[#708090] dark:text-[#96abdc] text-lg mb-8 transition-colors duration-300">
                  The following activities are strictly prohibited and will result in immediate action against your account.
                </p>
                  ...
                  {prohibitedActivities.map((category, index) => (
                    <div key={index} className="border-l-4 border-red-500 bg-red-50 dark:bg-red-900/20 p-6 rounded-r-lg">
                      ...
                      <div className="mb-4">
                        ...
                        <ul className="space-y-2">
                          {category.activities.map((activity, activityIndex) => (
                            <li key={activityIndex} className="flex items-start gap-2 text-red-700 dark:text-red-300">
                      ...
                      <div className="bg-red-100 dark:bg-red-900/40 p-3 rounded-lg">
                        <h5 className="font-semibold text-red-800 dark:text-red-300 mb-1">Consequences:</h5>
                        <p className="text-red-700 dark:text-red-300 text-sm">{category.consequences}</p>
                      </div>
                    </div>
                  ))}
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-yellow-700 dark:text-yellow-300">
                        Violating these guidelines can result in permanent account termination and may be reported to appropriate authorities when illegal activities are involved. We maintain zero tolerance for activities that harm our community or violate applicable laws.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          {activeTab === 'reporting' && (
            <div className="space-y-8">
              <div className="bg-white dark:bg-[#001a1a] rounded-xl shadow-xl p-8 border border-gray-200 dark:border-[#004953] transition-colors duration-300">
                ...
                <p className="text-[#708090] dark:text-[#96abdc] text-lg mb-8 transition-colors duration-300">
                  Help us maintain a safe community by reporting violations quickly and effectively.
                </p>
                        ...
                        <div className="flex-1">
                          ...
                          <ul className="space-y-2">
                            {step.details.map((detail, detailIndex) => (
                              <li key={detailIndex} className="flex items-start gap-2 text-sm text-[#708090] dark:text-[#96abdc] transition-colors duration-300">
                ...
                <div className="bg-gradient-to-r from-[#ed5925] to-[#ed5925]/80 p-6 rounded-lg text-white">
                  <h3 className="text-xl font-bold mb-4">Emergency Reporting</h3>
                  <p className="mb-4">
                    For immediate threats, harassment, or urgent safety concerns, contact us immediately:
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    <div>
                      <strong>Emergency Email:</strong><br />
          ...
          {activeTab === 'moderation' && (
            <div className="space-y-8">
              <div className="bg-white dark:bg-[#001a1a] rounded-xl shadow-xl p-8 border border-gray-200 dark:border-[#004953] transition-colors duration-300">
                ...
                <p className="text-[#708090] dark:text-[#96abdc] text-lg mb-8 transition-colors duration-300">
                  Understanding our moderation process and the actions we may take to maintain community standards.
                </p>

                <div className="space-y-6">
                  {moderationActions.map((action, index) => (
                    <div key={index} className="border border-gray-200 dark:border-[#004953] rounded-lg p-6 transition-colors duration-300">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-xl font-bold text-[#002244] dark:text-white transition-colors duration-300">
                          {action.action}
                        </h3>
                        <span className={`px-3 py-1 rounded-full text-xs font-bold ${
                          action.action === 'Warning' ? 'bg-yellow-500 text-white' :
                          action.action === 'Content Removal' ? 'bg-orange-500 text-white' :
                          action.action === 'Temporary Restriction' ? 'bg-blue-500 text-white' :
                          action.action === 'Account Suspension' ? 'bg-red-500 text-white' :
                          'bg-black text-white'
                        }`}>
                          {action.duration}
                        </span>
                ...
                <div className="mt-8 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 p-6 rounded-lg">
                  <h3 className="font-bold text-blue-800 dark:text-blue-300 mb-4">Appeals Process</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">How to Appeal:</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">Review Process:</h4>
                      <ul className="space-y-1 text-sm text-blue-700 dark:text-blue-300">
              ...
              <div className="bg-white dark:bg-[#001a1a] rounded-xl shadow-xl p-8 border border-gray-200 dark:border-[#004953] transition-colors duration-300">
                ...
                <div className="space-y-8">
                  {safetyTips.map((section, index) => (
                    <div key={index} className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 p-6 rounded-lg border border-green-200 dark:border-green-800">
                      <h3 className="text-xl font-bold text-green-800 dark:text-green-300 mb-4">
                        {section.category}
                      </h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {section.tips.map((tip, tipIndex) => (
                          <div key={tipIndex} className="flex items-start gap-3 bg-white dark:bg-[#001a1a] p-4 rounded-lg">
                ...
                <div className="mt-8 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 p-6 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-red-800 dark:text-red-300 mb-4">Red Flags - Report Immediately</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <ul className="space-y-2">
