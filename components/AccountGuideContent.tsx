  ...
  const setupSteps = [
    {
      ...
      warning: "Choose your username carefully - it can't be changed later and will be visible to other players.",
    },
    {
      step: 2,
      ...
      warning: "You cannot participate in paid games until your email is verified.",
    },
    {
      step: 3,
      ...
      warning: "Keep personal information minimal - this is a public gaming platform.",
    },
    {
      step: 4,
      ...
      warning: "Never share your seed phrase with anyone - Coach B will never ask for it! You maintain full control of your funds.",
    },
  ];
  ...
  const accountFeatures = [
    {
      ...
      access: ["Game browsing", "Community participation", "Account notifications"],
      timeframe: "Instant",
      benefits: ["Platform communications", "Game notifications", "Community support"],
    },
    {
      ...
      timeframe: "Instant",
      benefits: ["Trustless gameplay", "Immediate payouts", "Full fund control"],
    },
    {
      feature: "Smart Contract Understanding",
      requirements: ["Basic blockchain knowledge", "Understand transaction finality"],
      access: ["Confident gameplay", "Advanced features", "Risk awareness"],
      timeframe: "Educational",
      benefits: ["Informed decisions", "Security awareness", "Better experience"],
    },
  ];
  ...
  const preferencesOptions = [
    {
      ...
      options: [
        { name: "Board filling alerts", description: "When boards are nearly full" },
        { name: "Game start reminders", description: "15 minutes before kickoff" },
        { name: "Quarter end updates", description: "Scoring results and payouts" },
    ...
    },
    {
      ...
      options: [
        { name: "Weekly newsletters", description: "Game schedules and promotions" },
        { name: "Special offers", description: "VIP deals and bonus opportunities" },
        { name: "Community updates", description: "New features and announcements" },
        { name: "Fantasy football content", description: "Tips and strategy guides" },
      ],
    },
    {
      category: "Privacy Settings",
      options: [
        { name: "Public profile", description: "Show your stats to other players" },
        { name: "Leaderboard participation", description: "Appear in public rankings" },
        { name: "Social features", description: "Allow friend requests and messages" },
        { name: "Data sharing", description: "Improve platform with usage analytics" },
      ],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[#708090] dark:text-[#96abdc] max-w-3xl mx-auto mb-8 transition-colors duration-300">
            Everything you need to know about creating, verifying, and managing your Football Squares account.
            From basic setup to advanced security features.
          </p>
          ...
          {activeTab === "setup" && (
            <div className="p-8 lg:p-12">
              ...
              <div className="space-y-8">
                {setupSteps.map((step) => (
                  <Card key={step.step} className="border-l-4 border-l-[#ed5925]">
                    <CardHeader>
              ...
              <div className="mt-12 text-center bg-gradient-to-r from-[#002244] to-[#004953] rounded-xl p-8 text-white">
                ...
                <p className="text-[#96abdc] mb-6">
                  Follow these steps and you'll be playing Football Squares in under 10 minutes!
                </p>
            ...
            <div className="p-8 lg:p-12">
              ...
              <div className="mb-8">
                <p className="text-center text-[#708090] dark:text-[#96abdc] max-w-2xl mx-auto transition-colors duration-300">
                  Different setup levels provide different experiences. Start simple and add features as you explore Football Squares.
                </p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {accountFeatures.map((feature, index) => (
                  <Card key={index} className={`relative ${index === 1 ? 'border-[#ed5925] border-2' : ''}`}>
                    {index === 1 && (
                      ...
                      <div>
                        ...
                        <ul className="space-y-1">
                          {feature.access.map((access, accessIndex) => (
                            <li key={accessIndex} className="flex items-start gap-2">
              ...
              <div className="mt-12 bg-[#faf9f5] dark:bg-[#1a1a2e] rounded-xl p-8 transition-colors duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    <h4 className="font-semibold text-[#ed5925] mb-3">🛡️ Essential Security:</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-[#004953] mb-3">⚡ Smart Contract Benefits:</h4>
                    <ul className="space-y-2">
                      {[
                    ...
                    <CardHeader>
                      <CardTitle className="flex items-center gap-4">
                        ...
                        <div className={`px-3 py-1 rounded-full text-xs font-bold ${
                          feature.importance === 'Critical' ? 'bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-300' :
                          feature.importance === 'High' ? 'bg-orange-100 text-orange-800 dark:bg-orange-900/20 dark:text-orange-300' :
          ...
          {activeTab === "preferences" && (
            <div className="p-8 lg:p-12">
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {category.options.map((option, optionIndex) => (
                          <div key={optionIndex} className="flex items-center justify-between p-4 bg-[#faf9f5] dark:bg-[#1a1a2e] rounded-lg transition-colors duration-300">
                            <div>
              ...
              <div className="mt-12 bg-[#faf9f5] dark:bg-[#1a1a2e] rounded-xl p-8 transition-colors duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <h4 className="font-semibold text-[#ed5925] mb-3">🌍 Regional Settings</h4>
                  ...
                  <div className="space-y-4">
                    <h4 className="font-semibold text-[#ed5925] mb-3">🎮 Gaming Preferences</h4>
                    <div className="space-y-2">
                      <div>
                        <label className="block text-sm font-medium text-[#002244] dark:text-white mb-1 transition-colors duration-300">
                          Default Game Type
