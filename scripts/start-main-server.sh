...
start_nextjs() {
    ...
    PATH="/home/new-msi/.nvm/versions/node/v22.18.0/bin:$PATH" pnpm run dev > "$LOG_DIR/nextjs.log" 2>&1 &
    NEXTJS_PID=$!
...
start_bore() {
    ...
    cd /home/new-msi/workspace/fsq
    ./bore local 3001 --to bore.pub --port 3002 > "$LOG_DIR/bore.log" 2>&1 &
    BORE_PID=$!
...
echo "Access the application at: http://bore.pub:3002/"
echo "Main branch Football Squares site"
echo ""
