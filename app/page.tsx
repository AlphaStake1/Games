      ...
      <div className="min-h-screen bg-[#faf9f5] dark:bg-[#444341] py-8">
        <div className="container mx-auto px-4">
          <div className="mb-8 text-center">
            <h1 className="text-4xl font-bold mb-2 text-[#002244] dark:text-white">Football Squares</h1>
            <p className="text-[#708090] dark:text-[#96abdc]">Game ID: {gameId}</p>
          </div>
              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-16">
                  ...
                  <Card className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-all duration-300">
                    <CardHeader>
                      ...
                      <CardDescription className="text-gray-600 dark:text-gray-400">
                        Compete all season long and accumulate points to win big prizes
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="space-y-2">
                        <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">Season Pass Benefits:</p>
                  ...
                  <Card className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-all duration-300">
                    ...
                    <CardContent className="space-y-4">
                      <div className="space-y-2">
                        <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">Weekly Game Features:</p>
                        <ul className="text-sm space-y-1 text-gray-600 dark:text-gray-400">
              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                  <Card className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-all duration-300">
                    ...
                    <CardContent className="space-y-4">
                      <div className="space-y-2">
                        <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">Learn About:</p>
                        <ul className="text-sm space-y-1 text-gray-600 dark:text-gray-400">
                  ...
                  <Card className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-all duration-300">
                    <CardHeader>
                      ...
                      <CardDescription className="text-gray-600 dark:text-gray-400">
                        Use fantasy insights to enhance your squares game strategy
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="space-y-2">
                        <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">Strategic Advantages:</p>
                        <ul className="text-sm space-y-1 text-gray-600 dark:text-gray-400">
                ...
                <div className="mb-12">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                    {[
                      { name: "ESPN Fantasy", url: "https://fantasy.espn.com", icon: "🏈", color: "from-red-600 to-red-800" },
                      { name: "Yahoo Fantasy", url: "https://football.fantasysports.yahoo.com", icon: "⚡", color: "from-purple-600 to-purple-800" },
                      { name: "NFL Fantasy", url: "https://fantasy.nfl.com", icon: "🏆", color: "from-blue-600 to-blue-800" },
                      { name: "Sleeper", url: "https://sleeper.app", icon: "💤", color: "from-green-600 to-green-800" },
                      { name: "CBS Sports", url: "https://www.cbssports.com/fantasy/football", icon: "📊", color: "from-orange-600 to-orange-800" },
                      { name: "FanDuel", url: "https://www.fanduel.com", icon: "🎲", color: "from-indigo-600 to-indigo-800" }
                    ].map((platform, index) => (
                      <Card key={index} className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer group">
                        <CardContent className="p-4 text-center">
                          <div className={`bg-gradient-to-r ${platform.color} w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-200`}>
                            <span className="text-2xl">{platform.icon}</span>
                          </div>
                          <h4 className="font-semibold text-gray-900 dark:text-white text-sm mb-2">{platform.name}</h4>
                          <Button
                            variant="outline"
                            size="sm"
                ...
                <div className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-lg p-6 shadow-sm">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                    <div className="space-y-2">
                      ...
                      <div className="text-sm text-gray-600 dark:text-gray-400">Regular Season Weeks</div>
                    </div>
                    <div className="space-y-2">
                      <div className="text-2xl font-bold text-green-600">32</div>
                      <div className="text-sm text-gray-600 dark:text-gray-400">NFL Teams</div>
                    </div>
                    <div className="space-y-2">
                      <div className="text-2xl font-bold text-purple-600">18</div>
                      <div className="text-sm text-gray-600 dark:text-gray-400">Total Season Weeks</div>
                    </div>
                    <div className="space-y-2">
                      <div className="text-2xl font-bold text-orange-600">272</div>
                      <div className="text-sm text-gray-600 dark:text-gray-400">Regular Season Games</div>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  {[
                    {
                      ...
                      description: "Using Switchboard VRF for provably fair number generation"
                    },
                    {
                      icon: "⚡",
                      title: "Automated Payouts",
                      description: "Winners are paid automatically via smart contract"
                    },
                    {
                      icon: "📊",
                    ...
                    },
                    {
                      ...
                      description: "All game logic runs on-chain with full transparency"
                    },
                    {
                      icon: "💰",
                      title: "Low Fees",
                      description: "Minimal transaction fees thanks to Solana's efficiency"
                    },
                    {
                      icon: "📧",
                      title: "Email Notifications",
                      description: "Get notified when you win or when games start"
                    }
                  ].map((feature, index) => (
                    <Card key={index} className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    { game: "Game #4872", winner: "Player123", amount: "$2,500", quarter: "Final" },
                    { game: "Game #4865", winner: "SquaresMaster", amount: "$1,200", quarter: "Q3" },
                    { game: "Game #4791", winner: "Michael V", amount: "$3,100", quarter: "Final" },
                    { game: "Game #4783", winner: "GridIron99", amount: "$850", quarter: "Q2" },
                    { game: "Game #4724", winner: "TouchdownKing", amount: "$1,900", quarter: "Q4" },
                    { game: "Game #4716", winner: "SquareWinner", amount: "$750", quarter: "Q1" }
                  ].map((winner, index) => (
                    <Card key={index} className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 shadow-sm">
                      <CardContent className="p-6">
                        <div className="flex items-center justify-between mb-3">
                          <span className="text-sm font-medium text-blue-600 dark:text-blue-400">{winner.game}</span>
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="font-semibold text-gray-900 dark:text-white">{winner.winner}</p>
                            <p className="text-sm text-gray-600 dark:text-gray-400">Winner</p>
                          </div>
                          <div className="text-right">
                            <p className="text-2xl font-bold text-green-600 dark:text-green-400">{winner.amount}</p>
              ...
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12">
                  ...
                  <p className="text-lg text-gray-600 dark:text-gray-400 mb-4">
                    Real testimonials from players who enjoyed our physical boards
                  </p>
                  <p className="text-base text-gray-500 dark:text-gray-500 italic">
                    These amazing experiences inspired Coach B to bring Football Squares to the digital world so more players can enjoy the game
                  </p>
                </div>
                  ...
                  {[
                    {
                      ...
                      quote: "I've been playing football squares for years, but this platform makes it so much easier. The automated payouts are a game-changer!",
                      rating: 5
                    },
                    {
                      name: "Mike R.",
                      role: "Weekly Player",
                      quote: "Love the transparency of the blockchain. I can verify every game and know my winnings are secure. Plus, the strategy guides helped me improve my picks!",
                      rating: 5
                    },
                    {
                      name: "Jennifer L.",
                      role: "Fantasy Football Enthusiast",
                      quote: "The integration with fantasy football insights is brilliant. I use the platform stats to make better decisions in both games.",
                      rating: 5
                    }
              ...
              <div className="max-w-4xl mx-auto text-center">
                <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
                  ...
                  <p className="text-lg mb-6 opacity-90">
                    Get weekly NFL insights, game alerts, and exclusive tips delivered to your inbox
                  </p>
