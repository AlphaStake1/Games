...
import { Play, Users, Star, PenTool, Image as ImageIcon, ArrowLeft, Info } from "lucide-react";
...
export default function FreeBoardPage() {
  ...
  const handleUpgradeClick = (upgradeId: string) => {
    ...
    setTimeout(() => {
      ...
      alert(`Upgrade to ${upgradeOptions.find(opt => opt.id === upgradeId)?.label} initiated!`);
    }, 1000);
  };
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#faf9f5] dark:bg-[#1a1a2e] py-6 sm:py-12" lang="en">
        ...
        <header className="text-center mb-8">
          ...
          <p className="text-base sm:text-lg text-[#708090] dark:text-[#96abdc] mb-4">
            Join a free board featuring the Dallas Cowboys vs. {SUPERBOWL_WINNER}. Claim your square and experience Football Squares with no cost!
          </p>
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 max-w-2xl mx-auto">
            <div className="flex items-start gap-3">
              <Info className="w-5 h-5 text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0" />
              <div className="text-sm text-blue-800 dark:text-blue-200">
                <p className="font-medium mb-1">How Football Squares Works:</p>
                <p>
                  Pick squares on the 10x10 grid. Numbers are randomly assigned after all squares are claimed.
        ...
        {/* Board Preview */}
        <section className="bg-white dark:bg-[#002244] rounded-2xl shadow-lg p-4 sm:p-6 mb-10" aria-labelledby="board-title">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between mb-6">
            <div className="flex items-center gap-2 sm:gap-4 text-center">
              <span className="text-lg sm:text-2xl font-bold text-blue-700 dark:text-blue-300">🏈 Dallas Cowboys</span>
              <span className="text-sm sm:text-lg font-semibold text-gray-500 dark:text-gray-300">vs.</span>
              <span className="text-lg sm:text-2xl font-bold text-red-700 dark:text-red-300">🏆 {SUPERBOWL_WINNER}</span>
            </div>
            ...
            <div className="inline-block border-2 border-gray-400 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800">
              ...
              <div className="bg-gradient-to-r from-blue-700 to-blue-600 text-white px-4 py-2 text-center border-b-2 border-gray-400 dark:border-gray-600">
                <div className="flex items-center justify-center gap-2">
                  <span className="font-bold text-sm sm:text-base">DALLAS COWBOYS</span>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Click any available square to claim it. Claimed squares: {claimedSquares.size}/100
            </p>
            <button
            ...
            >
              {isLoading ? 'Processing...' : `Confirm ${claimedSquares.size} Square${claimedSquares.size !== 1 ? 's' : ''}`}
            </button>
          </div>
        </section>

        {/* NFT Upgrade Options */}
        <section className="bg-white dark:bg-[#002244] rounded-2xl shadow-lg p-4 sm:p-6 mb-10" aria-labelledby="upgrade-title">
          <h2 id="upgrade-title" className="text-xl sm:text-2xl font-bold mb-4 text-[#002244] dark:text-white">
            Upgrade Your Board Placement NFT
          </h2>
          <p className="text-sm sm:text-base text-[#708090] dark:text-[#96abdc] mb-6">
            Enhance your Football Squares experience with unique NFT upgrades. Each upgrade provides different visual and functional benefits.
          </p>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="font-semibold text-sm sm:text-lg text-[#002244] dark:text-white flex items-center justify-between">
                    {option.label}
                    <span className="text-xs sm:text-sm text-[#ed5925] font-medium">{option.price}</span>
                  </div>
                  <div
                    id={`desc-${option.id}`}
        ...
        {/* Game Information */}
        <section className="bg-white dark:bg-[#002244] rounded-2xl shadow-lg p-4 sm:p-6 mb-10" aria-labelledby="game-info-title">
          <h2 id="game-info-title" className="text-xl sm:text-2xl font-bold mb-4 text-[#002244] dark:text-white">
            Game Information
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-semibold text-lg text-[#002244] dark:text-white mb-2">How to Play</h3>
            ...
            <div>
              <h3 className="font-semibold text-lg text-[#002244] dark:text-white mb-2">Game Details</h3>
