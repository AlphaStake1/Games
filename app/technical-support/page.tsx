...
export const metadata: Metadata = {
  ...
  description: "Get help with technical issues, troubleshoot common problems, and learn how to resolve account, payment, and gaming issues on Football Squares.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Comprehensive technical support and troubleshooting guide for Football Squares platform issues.",
    type: "website",
  ...
  twitter: {
    ...
    title: "Technical Support Guide - Football Squares",
    description: "Get help with technical issues and troubleshoot common problems on Football Squares.",
